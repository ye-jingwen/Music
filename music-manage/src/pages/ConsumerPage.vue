<template>
    <div class="table">
        ...
        <!-- 用户列表显示 -->
        <el-table size="mini" ref="multipleTable" border style="width:100%" height="540px" :data="data" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="location" label="地区" width="100" text-align="center"></el-table-column>
        ...
        <el-dialog title="添加新用户" :visible.sync="centerDialogVisible" width="400px" center>
            ...
            <span slot="footer">
                ...
                <el-button size="mini" @click="insertConsumer">确定</el-button>
            </span>
        </el-dialog>
        ...
        insertConsumer() {
            this.$refs["registerForm"].validate((valid) => {
                if (valid) {
                    ...
                    params.append("avator", "/img/userPic/userDefault.jpg");
